        ...
        <div className="max-w-7xl mx-auto">
          ...
          {mainSkills.map((skill, index) => (
            <div
              key={skill.id}
              id={skill.id}
              className="glassmorphism p-6 rounded-2xl mb-12 animate-fade-in"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="bg-psyco-black-card p-3 rounded-lg text-psyco-green-DEFAULT">
                  {skill.icon}
                </div>
                <h3 className="text-2xl font-semibold text-psyco-orange-light">
                  {skill.title}
                </h3>
              </div>
