    ...
    emailjs
      ...
      .then(
        () => {
          ...
          setStatusMessage("Message Sent! Thank you for reaching out. I'll get back to you soon.");
          toast({
            title: "Message Sent!",
        ...
        (error) => {
          ...
          setIsSubmitting(false);
          setStatusType("error");
          setStatusMessage("Something went wrong! Please try again later or contact directly via email.");
          toast({
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="firstName" name="firstName" type="text" required className="bg-psyco-black-DEFAULT border-psyco-green-muted/50 bg-gray-900 text-orange-400 placeholder:text-gray-600" placeholder="Akshat" />
                  </div>
                  <div>
                    <label htmlFor="lastName" className="block text-sm font-medium text-gray-300 mb-2">Last Name</label>
                    <Input id="lastName" name="lastName" type="text" required className="bg-psyco-black-DEFAULT border-psyco-green-muted/50 bg-gray-900 text-orange-400 placeholder:text-gray-600" placeholder="Jangid" />
                  </div>
                </div>

                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2">Email Address</label>
                  <Input id="email" name="email" type="email" required className="bg-psyco-black-DEFAULT border-psyco-green-muted/50 bg-gray-900 text-orange-400 placeholder:text-gray-600" placeholder="akshatjangid14@gmail.com" />
                </div>

                <div>
                  <label htmlFor="subject" className="block text-sm font-medium text-gray-300 mb-2">Subject</label>
                  <Input id="subject" name="subject" type="text" required className="bg-psyco-black-DEFAULT border-psyco-green-muted/50 bg-gray-900 text-orange-400 placeholder:text-gray-600" placeholder="Project Collaboration" />
                </div>

                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-2">Message</label>
                  <Textarea id="message" name="message" required rows={6} className="bg-psyco-black-DEFAULT border-psyco-green-muted/50 resize-none bg-gray-900 text-orange-400 placeholder:text-gray-600" placeholder="Tell me about your project or what you'd like to discuss..." />
                </div>

                <Button type="submit" disabled={isSubmitting} className="w-full text-white font-medium py-3 rounded-lg transition-colors flex items-center justify-center">
                  {isSubmitting ? "Sending..." : <>Send Message <Send className="ml-2 h-4 w-4" /></>}
                </Button>

                {statusMessage && (
                  <p
                    className={`text-sm mt-4 ${statusType === "success" ? "text-green-500" : "text-red-500"
                      }`}
                  >
                    {statusMessage}
                  </p>
            ...
            <div className="space-y-8">
              <div className="glassmorphism p-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    <div className="bg-psyco-green-DEFAULT/20 p-3 rounded-lg"><Mail className="h-6 w-6 text-psyco-green-DEFAULT" /></div>
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="bg-psyco-green-DEFAULT/20 p-3 rounded-lg"><Phone className="h-6 w-6 text-psyco-green-DEFAULT" /></div>
                    <div>
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="bg-psyco-green-DEFAULT/20 p-3 rounded-lg"><MapPin className="h-6 w-6 text-psyco-green-DEFAULT" /></div>
                    <div>
              ...
              <div className="glassmorphism p-8">
                ...
                <div className="space-y-4">
                  <a href="https://github.com/AkshatJangid787" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 p-4 bg-psyco-black-DEFAULT rounded-lg hover:bg-psyco-black-card transition-colors">
                  ...
                  <a href="https://www.linkedin.com/in/akshatjangid/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 p-4 bg-psyco-black-DEFAULT rounded-lg hover:bg-psyco-black-card transition-colors">
                  ...
                  <a href="https://x.com/AkshatJangid777" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-4 p-4 bg-psyco-black-DEFAULT rounded-lg hover:bg-psyco-black-card transition-colors">
      ...
      <section className="py-16 px-6 md:px-12 bg-psyco-black-light">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">Common questions about working with me</p>
          </div>
